...
VALUES (1, 'US', 'AMERICAS', 'University of Guam', 'university_of_guam', '괌대학(A형)',
       ...
       (2, 'US', 'AMERICAS', 'University of Guam', 'university_of_guam', '괌대학(B형)',
        'https://www.uog.edu/life-at-uog/residence-halls/', 'https://www.uog.edu/admissions/course-schedule',
        'https://www.uog.edu/admissions/international-students', NULL,
        'https://solid-connection.s3.ap-northeast-2.amazonaws.com/original/university_of_guam/logo.png',
        'https://solid-connection.s3.ap-northeast-2.amazonaws.com/original/university_of_guam/1.png'),
       (3, 'US', 'AMERICAS', 'University of Nevada, Las Vegas', 'university_of_nevada_las_vegas', '네바다주립대학 라스베이거스(B형)',
       ...
       (4, 'CA', 'AMERICAS', 'Memorial University of Newfoundland St. John''s',
        'memorial_university_of_newfoundland_st_johns', '메모리얼 대학 세인트존스(A형)', 'https://www.mun.ca/residences/',
       ...
       (5, 'CA', 'AMERICAS', 'Memorial University of Newfoundland St. John''s',
        'memorial_university_of_newfoundland_st_johns', '메모리얼 대학 세인트존스(B형)', 'www.mun.ca/residences',
        'https://www.mun.ca/regoff/registration-and-final-exams/course-offerings/',
        'https://mun.ca/goabroad/visiting-students-inbound/', NULL,
        'https://solid-connection.s3.ap-northeast-2.amazonaws.com/original/memorial_university_of_newfoundland_st_johns/logo.png',
        'https://solid-connection.s3.ap-northeast-2.amazonaws.com/original/memorial_university_of_newfoundland_st_johns/1.png'),
       (6, 'AU', 'AMERICAS', 'University of Southern Queensland', 'university_of_southern_queensland', '서던퀸스랜드대학(B형)',
       ...
       (7, 'AU', 'AMERICAS', 'University of Sydney', 'university_of_sydney', '시드니대학',
       ...
       (8, 'AU', 'AMERICAS', 'Curtin University', 'curtin_university', '커틴대학(A형)',
       ...
       (9, 'DK', 'EUROPE', 'University of Southern Denmark', 'university_of_southern_denmark', '서던덴마크대학교',
       ...
       (10, 'DK', 'EUROPE', 'IT University of Copenhagen', 'it_university_of_copenhagen', '코펜하겐 IT대학',
       ...
       (11, 'DE', 'EUROPE', 'Neu-Ulm University of Applied Sciences', 'neu-ulm_university_of_applied_sciences',
        '노이울름 대학',
       ...
       (12, 'GB', 'EUROPE', 'University of Hull', 'university_of_hull', '헐대학',
       ...
       (13, 'AT', 'EUROPE', 'University of Graz', 'university_of_graz', '그라츠 대학',
       ...
       (14, 'AT', 'EUROPE', 'Graz University of Technology', 'graz_university_of_technology', '그라츠공과대학',
       ...
       (15, 'AT', 'EUROPE', 'Catholic Private University Linz', 'catholic_private_university_linz', '린츠 카톨릭 대학교', NULL,
       ...
       (16, 'AT', 'EUROPE', 'University of Applied Sciences Technikum Wien',
       ...
       (17, 'FR', 'EUROPE', 'IPSA', 'ipsa', 'IPSA', 'https://www.ipsa.fr/en/student-life/pratical-information/', NULL,
       ...
       (18, 'JP', 'ASIA', 'Meiji University', 'meiji_university', '메이지대학',
       ...
       (19, 'JP', 'ASIA', 'BAIKA Women''s University', 'baika_womens_university', '바이카여자대학',
       ...
       (20, 'JP', 'ASIA', 'Bunkyo Gakuin University', 'bunkyo_gakuin_university', '분쿄가쿠인대학', NULL, NULL,
...
INSERT INTO university_info_for_apply(term, university_id, semester_requirement, student_capacity,
...
VALUES ('2024-1', 1, 2, 1, 'IRRELEVANT', 'HOME_UNIVERSITY_PAYMENT', '파견대학에 지원하는 전공과 본교 전공이 일치해야함', NULL,
        '외국어 성적 유효기간이 파견대학의 지원시까지 유효해야함', NULL, NULL, NULL),
       ('2024-1', 2, 2, 2, 'IRRELEVANT', 'OVERSEAS_UNIVERSITY_PAYMENT', '파견대학에 지원하는 전공과 본교 전공이 일치해야함', NULL,
        '외국어 성적 유효기간이 파견대학의 지원시까지 유효해야함', NULL, NULL, '등록금 관련 정보: https://www.uog.edu/financial-aid/cost-to-attend'),
       ('2024-1', 3, 2, 5, 'IRRELEVANT', 'OVERSEAS_UNIVERSITY_PAYMENT',
       ...
       ('2024-1', 4, 2, 4, 'ONE_SEMESTER', 'HOME_UNIVERSITY_PAYMENT',
        ...
        NULL, NULL, NULL),
       ('2024-1', 5, 2, 5, 'IRRELEVANT', 'OVERSEAS_UNIVERSITY_PAYMENT',
        '타전공 지원 및 수강 가능 <br>- 지원불가능전공: Medicine, Pharmacy, Social work, Nursing<br>- Computer Science, Music 지원 제한적',
        NULL,
        '영어 점수는 다음의 세부영역 점수를 각각 만족해야함<br>  - TOEFL iBT : 읽기/쓰기 20점, 듣기/말하기 17점 이상<br>  - IELTS : 모든 영역에서 6.0 이상<br> - 외국어 성적 유효기간이 파견대학의 학기 시작하는 날까지 유효해야함 ',
        NULL, NULL, '국제학생 등록금 적용 (학점당 $2,080)'),
       ('2024-1', 6, 2, 5, 'ONE_SEMESTER', 'OVERSEAS_UNIVERSITY_PAYMENT',
       ...
       ('2024-1', 7, 2, 5, 'IRRELEVANT', 'OVERSEAS_UNIVERSITY_PAYMENT',
       ...
       ('2024-1', 8, 2, 3, 'ONE_SEMESTER', 'HOME_UNIVERSITY_PAYMENT',
       ...
       ('2024-1', 9, 4, 2, 'IRRELEVANT', 'HOME_UNIVERSITY_PAYMENT',
       ...
       ('2024-1', 10, 2, 2, 'ONE_SEMESTER', 'HOME_UNIVERSITY_PAYMENT',
       ...
       ('2024-1', 11, 2, 3, 'IRRELEVANT', 'HOME_UNIVERSITY_PAYMENT', '타전공 지원 및 수강 가능', NULL,
        ...
        NULL, NULL, NULL),
       ('2024-1', 12, 4, 3, 'ONE_SEMESTER', 'HOME_UNIVERSITY_PAYMENT',
       ...
       ('2024-1', 13, 3, 2, 'IRRELEVANT', 'HOME_UNIVERSITY_PAYMENT', '-주전공 혹은 제2전공(혹은 연계전공과) 유관학과여아 함',
        '선발인원 중 차순위 합격자는 학기제한(1개 학기)이 있을 수 있음', NULL, NULL, '학교인근 외부 숙소는 있지만, 외부업체운영숙소라 대학관할아님', NULL),
       ('2024-1', 14, 2, 2, 'IRRELEVANT', 'HOME_UNIVERSITY_PAYMENT', '-주전공 혹은 제2전공(혹은 연계전공과) 유관학과여아 함',
        ...
        NULL),
       ('2024-1', 15, 3, 2, 'ONE_SEMESTER', 'HOME_UNIVERSITY_PAYMENT',
       ...
       ('2024-1', 16, 3, 2, 'IRRELEVANT', 'HOME_UNIVERSITY_PAYMENT',
       ...
       ('2024-1', 17, 4, 3, 'IRRELEVANT', 'HOME_UNIVERSITY_PAYMENT',
       ...
       ('2024-1', 18, 2, 3, 'IRRELEVANT', 'HOME_UNIVERSITY_PAYMENT',
